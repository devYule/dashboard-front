...
export default function Contents({ query }: { query: string | null }) {
  ...
  const addImg = (
    <svg viewBox="0 0 27 35" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.92838e-07 33.9055V4.3749C2.92838e-07 3.2146 0.460936 2.10183 1.28141 1.28138C2.10188 0.460926 3.21468 0 4.375 0L21.875 0C23.0353 0 24.1481 0.460926 24.9686 1.28138C25.7891 2.10183 26.25 3.2146 26.25 4.3749V33.9055C26.2501 34.0954 26.2008 34.2821 26.1069 34.4472C26.013 34.6123 25.8777 34.75 25.7143 34.8469C25.5509 34.9438 25.3652 34.9965 25.1753 34.9998C24.9854 35.0031 24.7979 34.9569 24.6313 34.8658L13.125 28.5878L1.61875 34.8658C1.45213 34.9569 1.26463 35.0031 1.07473 34.9998C0.884824 34.9965 0.699053 34.9438 0.535701 34.8469C0.372349 34.75 0.237048 34.6123 0.143116 34.4472C0.0491849 34.2821 -0.000138674 34.0954 2.92838e-07 33.9055ZM14.2188 9.84352C14.2188 9.55345 14.1035 9.27526 13.8984 9.07014C13.6933 8.86503 13.4151 8.7498 13.125 8.7498C12.8349 8.7498 12.5567 8.86503 12.3516 9.07014C12.1465 9.27526 12.0312 9.55345 12.0312 9.84352V13.1247H8.75C8.45992 13.1247 8.18172 13.2399 7.9766 13.445C7.77148 13.6502 7.65625 13.9284 7.65625 14.2184C7.65625 14.5085 7.77148 14.7867 7.9766 14.9918C8.18172 15.1969 8.45992 15.3121 8.75 15.3121H12.0312V18.5933C12.0312 18.8834 12.1465 19.1616 12.3516 19.3667C12.5567 19.5718 12.8349 19.687 13.125 19.687C13.4151 19.687 13.6933 19.5718 13.8984 19.3667C14.1035 19.1616 14.2188 18.8834 14.2188 18.5933V15.3121H17.5C17.7901 15.3121 18.0683 15.1969 18.2734 14.9918C18.4785 14.7867 18.5938 14.5085 18.5938 14.2184C18.5938 13.9284 18.4785 13.6502 18.2734 13.445C18.0683 13.2399 17.7901 13.1247 17.5 13.1247H14.2188V9.84352Z"
        fill="black"
      />
    </svg>
  );
  const bookmarkedImg = (
    <svg viewBox="0 0 27 35" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2.92838e-07 33.9055V4.3749C2.92838e-07 3.2146 0.460936 2.10183 1.28141 1.28138C2.10188 0.460926 3.21468 0 4.375 0L21.875 0C23.0353 0 24.1481 0.460926 24.9686 1.28138C25.7891 2.10183 26.25 3.2146 26.25 4.3749V33.9055C26.2501 34.0954 26.2008 34.2821 26.1069 34.4472C26.013 34.6123 25.8777 34.75 25.7143 34.8469C25.5509 34.9438 25.3652 34.9965 25.1753 34.9998C24.9854 35.0031 24.7979 34.9569 24.6313 34.8658L13.125 28.5878L1.61875 34.8658C1.45213 34.9569 1.26463 35.0031 1.07473 34.9998C0.884824 34.9965 0.699053 34.9438 0.535701 34.8469C0.372349 34.75 0.237048 34.6123 0.143116 34.4472C0.0491849 34.2821 -0.000138674 34.0954 2.92838e-07 33.9055ZM8.75 13.1247C8.45992 13.1247 8.18172 13.2399 7.9766 13.445C7.77148 13.6502 7.65625 13.9284 7.65625 14.2184C7.65625 14.5085 7.77148 14.7867 7.9766 14.9918C8.18172 15.1969 8.45992 15.3121 8.75 15.3121H17.5C17.7901 15.3121 18.0683 15.1969 18.2734 14.9918C18.4785 14.7867 18.5938 14.5085 18.5938 14.2184C18.5938 13.9284 18.4785 13.6502 18.2734 13.445C18.0683 13.2399 17.7901 13.1247 17.5 13.1247H8.75Z"
        fill="black"
      />
    </svg>
  );
    ...
    <>
      {isLoading && (
        <div className="contentsModal">
          <p className="typing-ani">
            {typingIdx > -1 && typingText.substring(0, typingIdx)}
          </p>
      ...
      <div className="contentsContainer">
        {contents.map((eachSite: OrderedSitesRef) => {
          return (
            <div
              key={eachSite.siteId}
              className={`site-box ${allSites[eachSite.siteId].title}`}
            >
              {/* 각 사이트별 이름 */}
              <div
                className="siteNameContainer"
                style={allSitesColors[eachSite.siteId]}
              >
                ...
                return (
                  <div className="item" key={idx}>
                    ...
                    <p
                      className="title"
                      onMouseEnter={() =>
                        titleOnMouseEnter(eachSite.siteId + "" + idx + "thBtn")
                      }
                      onMouseLeave={() =>
                    ...
                    >
                      {content.iconPath && content.iconPath.length > 0 ? (
                        ...
                        <div className="icon">
                          {eachSite.siteId === 0 ? (
                            ...
                            >
                              <path
                                d="M4.95829 1.75V5.25H4.52726L2.52295 2.50195H2.48703V5.25H2.04163V1.75H2.47266L4.48415 4.50488H4.52007V1.75H4.95829Z"
                                fill="black"
                              />
                              <rect
                                x="0.5"
                      ...
                      {addedIdx.siteId === eachSite.siteId &&
                      addedIdx.idx === idx ? (
                      ...
                      {content.content.length > 1 ? (
                        <>
                          ...
                          {content.content.map((c, idx) => {
                            ...
                            return (
                              <p className="text">
                                {stringSlicer(c, maxSize.contentsSize)}
                              </p>
                            );
                          })}
                        </>
  ...
  async function bookmarkBtnOnClick(
    ...
    if (content.bookmarkId > 0) {
      ...
      axiosInstance.delete(`/api/bm?id=${content.bookmarkId}`).then((res) => {
        if (res.data.code > 0) return;
        if (res.data.value === content.bookmarkId) {
          setContents(
            contents.map((c: OrderedSitesRef) => {
    ...
    setAddedIdx({ siteId: siteId, idx: idx });
    timeoutId = setTimeout(() => {
      setAddedIdx({ siteId: -1, idx: -1 });
    }, 2000);
  }
}
...
function onClickPlusRank(siteId: number) {
  axiosInstance.get(`/api/user/rank?id=${siteId}`).then((res) => {
    console.log("did");
  });
}
