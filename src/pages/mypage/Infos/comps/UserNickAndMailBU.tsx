    ...
    <>
      <div className="nickAndMail">
        {clickedItem !== "nick" ? (
          <p
            id="nick"
            onMouseEnter={() => onMouseEnter("nick")}
          ...
          <div className="changeContainer">
            ...
            {mailDisabled && (
              <div className="loading">
                ...
                >
                  <path
                    d="M9.375 18.75C11.8614 18.75 14.246 17.7623 16.0041 16.0041C17.7623 14.246 18.75 11.8614 18.75 9.375C18.75 6.8886 17.7623 4.50403 16.0041 2.74587C14.246 0.987719 11.8614 0 9.375 0C6.8886 0 4.50403 0.987719 2.74587 2.74587C0.987719 4.50403 0 6.8886 0 9.375C0 11.8614 0.987719 14.246 2.74587 16.0041C4.50403 17.7623 6.8886 18.75 9.375 18.75Z"
                    fill="black"
                  />
                </svg>
                <svg
