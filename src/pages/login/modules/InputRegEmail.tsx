...
export default function InputRegEmail({ servKey }:
    ...
    const mailPlaceholderClass = placeholder ? styles.placeholder : '';
    const codePlaceholderClass = code.length === 0 ? styles.placeholder : '';
        ...
        <>
            {!isValidating ? (
                <div className={mailContainerClassName}>
                    ...
                    <MailValidBtn className={styles.btns} style={emailBtnStyle} onClick={onBtnClick} disabled={!enabled}>
                ...
                <nav className={mailContainerClassName}>
                    ...
                    <DirectionBtn className={styles.btns} onClick={onBtnClick} disabled={!isValidating} btnStyle={codeBtnStyle} btnDirection={'right'} />
                </nav>
            )}
        </>
    );
